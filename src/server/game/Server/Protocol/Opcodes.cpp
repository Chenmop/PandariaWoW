...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
	...
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_CHAR_BOOST_ITEMS, 0x083B, STATUS_NEVER); // 5.4.8 1841
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_COMMAND_RESULT,            0x1A79, STATUS_NEVER); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_CONTENTS,                      0x121F, STATUS_NEVER); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ITEM_NOTIFY,                   0x080F, STATUS_NEVER); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_SLOT_CHANGED,                  0x0000, STATUS_NEVER);
